...
```json
{ "error": { "message": "Human-readable text", "code": "MACHINE_CODE", "details": [] } }
```
...
|---|---|
| *(none)* | Default page = 20 newest messages |
...
```json
{ "_id": "…", "conversation": "…", "sender": "<userId>", "text": "Hello!", "createdAt": "ISO" }
```
...
```json
{ "id": "…", "conversation": "…", "sender": "<userId>", "text": "Hello!", "createdAt": 1787311896872 }
```
