  ...
  return (
    <header className="absolute inset-x-0 top-0 z-20">
      ...
      >
        ...
        <Link
          href="/login"
          className="group relative flex h-[48px] w-[128px] select-none items-center justify-center rounded-[15px] p-[2px] transition-all duration-300 ease-out bg-[rgba(99,102,241,0.25)] bg-[linear-gradient(to_bottom_right,rgba(99,102,241,1)_0%,rgba(99,102,241,0)_35%)] hover:bg-[rgba(99,102,241,0.75)] hover:shadow-[0_0_14px_rgba(99,102,241,0.55)] focus:outline-none focus:ring-2 focus:ring-accent"
        >
